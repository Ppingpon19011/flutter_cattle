...
class CameraSideScreen extends StatefulWidget {
  final int idPro;
  final int idTime;
  ...
  @override
  _CameraSideScreenState createState() => _CameraSideScreenState();
}

class _CameraSideScreenState extends State<CameraSideScreen>
